...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleDeclined(PaymentDeclinedException ex, WebRequest request) {
        ApiError error = new ApiError(HttpStatus.PAYMENT_REQUIRED.value(), "Payment Declined",
                ex.getMessage(), request.getDescription(false).replace("uri=", ""));
